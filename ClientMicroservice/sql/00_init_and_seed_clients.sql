...
CREATE TABLE public.client (
    ...
    created_by              VARCHAR(150),  -- Nuevo
    modified_by             VARCHAR(150),  -- Nuevo
...
VALUES
    ('Juan',    'Pérez',     'López',      DATE '1990-01-01', 'C-123456', TRUE, NOW(), 'system', NULL, 'Principiante', 82.50, 82.50, '777-111'),
    ('María',   'González',  'Rojas',      DATE '1988-05-12', 'C-234567', TRUE, NOW(), 'system', NULL, 'Intermedio',   68.20, 67.00, '777-222'),
    ('Carlos',  'Ramírez',   'Soto',       DATE '1995-09-23', 'C-345678', TRUE, NOW(), 'system', NULL, 'Avanzado',     90.00, 88.30, '777-333'),
    ('Ana',     'Fernández', 'Díaz',       DATE '1992-03-04', 'C-456789', TRUE, NOW(), 'system', NULL, 'Principiante', 55.10, 54.80, '777-444'),
    ('Luis',    'Torres',    'Mendoza',    DATE '1985-12-31', 'C-567890', TRUE, NOW(), 'system', NULL, 'Intermedio',   76.00, 75.20, '777-555'),
    ('Sofía',   'Rivas',     'Ortega',     DATE '1998-07-15', 'C-678901', TRUE, NOW(), 'system', NULL, 'Avanzado',     62.00, 61.50, '777-666'),
    ('Miguel',  'Castro',    'Vega',       DATE '1993-11-20', 'C-789012', TRUE, NOW(), 'system', NULL, 'Principiante', 85.00, 84.50, '777-777'),
    ('Lucía',   'Navarro',   'Ibarra',     DATE '1991-04-18', 'C-890123', TRUE, NOW(), 'system', NULL, 'Intermedio',   58.00, 57.60, '777-888'),
    ('Diego',   'Salazar',   'Quispe',     DATE '1996-10-10', 'C-901234', TRUE, NOW(), 'system', NULL, 'Avanzado',     92.40, 91.00, '777-999'),
